...
#import "MYSessionDelegateViewController.h"
#import <Masonry/Masonry.h>

@interface MYSessionDelegateViewController () <NSURLSessionDataDelegate>

@property (nonatomic, strong) UIButton *btn;/**< request btn  */

@end

@implementation MYSessionDelegateViewController
